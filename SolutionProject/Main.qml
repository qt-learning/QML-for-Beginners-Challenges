...
Window {
    ...
    /* Requirements
        ...
        Use the QML Debugger to help you find and fix the following problems:

        - The dials don’t rotate as expected, behaving erratically
          and don’t seem to be able to rotate fully clockwise,
          stopping at the “3 o’clock” position.

        - Pressing the foot pedal makes the foot pedal and the LED disappear
        - The mode switch vanishes when it is clicked.
    */
    ...
    component SwitchImage: Image {
        ...
        // SOLUTION: The suffix "Checked" should be "-Checked" to match the desired file name rules.

        property string fileName: `assets/${sourceBaseName}${checked ? "-Checked" : ""}.png`
        source: fileName
    }
    ...
    component DeviceDial: Image {
        ...
        DragHandler {
            ...
            function updateValueAndRotation() {
                ...
                // SOLUTION: The endAngle should be the same as the startAngle (but positive)
                // to rotate around the complete arc required.
                ...
                // SOLUTION: The dial.angle needs to be positive, not negative
                // to rotate correctly.
